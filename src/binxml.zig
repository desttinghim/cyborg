...
const ResourceChunk = @import("binxml/ResourceChunk.zig");
const Value = @import("binxml/Value.zig");
const StringPool = @import("binxml/StringPool.zig");
const XMLTree = @import("binxml/XMLTree.zig");
const ResourceTable = @import("binxml/ResourceTable.zig");
