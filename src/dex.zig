...
pub const Ops = enum(u16) {
    ...
    @"move-wide/from16" = 0x05_22,
    /// Move the contents of one register pair to another.
    /// NOTE: It is legal to move from vN to either vN-1 or vN+1, so implementations must arrange for both halves of a register pair to be read before anything is written.
    /// move-wide/16 vAAAA, vBBBB
    /// A: destination register pair (8 bits)
    /// B: source register pair (16 bits)
    @"move-wide/16" = 0x06_32,
    ...
    /// A: destination register (8 bits)
    /// B: source register (16 bits)
    @"move-object/from16" = 0x08_22,
    /// Move the contents of one object-bearing register to another.
    /// move-object/16 vAAAA, vBBBB
    /// A: destination register (16 bits)
    /// B: source register (16 bits)
    @"move-object/16" = 0x09_32,
    ...
    @"monitor-enter" = 0x1d_11,
    @"monitor-exit" = 0x1e_11,
    @"check-cast" = 0x1f_21,
    @"instance-of" = 0x20_22,
    @"array-length" = 0x21_12,
    @"new-instance" = 0x22_21,
    @"new-array" = 0x23_22,
    @"filled-new-array" = 0x24_35,
    @"filled-new-array/range" = 0x25_30,
    @"filled-array-data" = 0x26_31,
    throw = 0x27_11,
    goto = 0x28_10,
    @"goto/16" = 0x29_20,
    @"goto/32" = 0x2a_30,
    @"packed-switch" = 0x2b_31,
    @"sparse-switch" = 0x2c_31,
    //
    @"cmpl-float" = 0x2d_23,
    @"cmpg-float" = 0x2e_23,
    @"cmpl-double" = 0x2f_23,
    ...
    @"sput-wide" = 0x68_21,
    @"sput-object" = 0x69_21,
    @"sput-boolean" = 0x6a_21,
    @"sput-byte" = 0x6b_21,
    @"sput-char" = 0x6c_21,
    @"sput-short" = 0x6d_21,
    // Invoke
    @"invoke-virtual" = 0x6e_35,
    @"invoke-super" = 0x6f_35,
    @"invoke-direct" = 0x70_35,
    @"invoke-static" = 0x71_35,
    @"invoke-interface" = 0x72_35,
    // Invoke/range
    @"invoke-virtual/range" = 0x6e_30,
    @"invoke-super/range" = 0x6f_30,
    @"invoke-direct/range" = 0x70_30,
    @"invoke-static/range" = 0x71_30,
    @"invoke-interface/range" = 0x72_30,
    // Unary operations
    @"neg-int" = 0x7b_10,
    @"not-int" = 0x7c_10,
    @"neg-long" = 0x7d_10,
    ...
    @"neg-double" = 0x80_10,
    @"int-to-long" = 0x81_10,
    @"int-to-float" = 0x82_10,
    @"int-to-double" = 0x83_10,
    @"long-to-int" = 0x84_10,
    @"long-to-float" = 0x85_10,
    @"long-to-double" = 0x86_10,
    @"float-to-int" = 0x87_10,
    @"float-to-long" = 0x88_10,
    @"float-to-double" = 0x89_10,
    @"double-to-int" = 0x8a_10,
    @"double-to-long" = 0x8b_10,
    @"double-to-float" = 0x8c_10,
    @"int-to-byte" = 0x8d_10,
    @"int-to-char" = 0x8e_10,
    @"int-to-short" = 0x8f_10,
    // Binary operations
    @"add-int" = 0x90_23,
    @"sub-int" = 0x91_23,
    @"mul-int" = 0x92_23,
    ...
    @"add-int/2addr" = 0xb0_12,
    @"sub-int/2addr" = 0xb1_12,
    @"mul-int/2addr" = 0xb2_12,
    @"div-int/2addr" = 0xb3_12,
    @"rem-int/2addr" = 0xb4_12,
    @"and-int/2addr" = 0xb5_12,
    @"or-int/2addr" = 0xb6_12,
    @"xor-int/2addr" = 0xb7_12,
    @"shl-int/2addr" = 0xb8_12,
    @"shr-int/2addr" = 0xb9_12,
    @"ushr-int/2addr" = 0xba_12,
    @"add-long/2addr" = 0xbb_12,
    @"sub-long/2addr" = 0xbc_12,
    @"mul-long/2addr" = 0xbd_12,
    @"div-long/2addr" = 0xbe_12,
    @"rem-long/2addr" = 0xbf_12,
    @"and-long/2addr" = 0xc0_12,
    @"or-long/2addr" = 0xc1_12,
    @"xor-long/2addr" = 0xc2_12,
    @"shl-long/2addr" = 0xc3_12,
    @"shr-long/2addr" = 0xc4_12,
    @"ushr-long/2addr" = 0xc5_12,
    @"add-float/2addr" = 0xc6_12,
    @"sub-float/2addr" = 0xc7_12,
    @"mul-float/2addr" = 0xc8_12,
    @"div-float/2addr" = 0xc9_12,
    @"rem-float/2addr" = 0xca_12,
    @"add-double/2addr" = 0xcb_12,
    @"sub-double/2addr" = 0xcc_12,
    @"mul-double/2addr" = 0xcd_12,
    @"div-double/2addr" = 0xce_12,
    @"rem-double/2addr" = 0xcf_12,
    // Binary operations with 16-bit literal value
    @"add-int/lit16" = 0xd0_12,
    @"sub-int/lit16" = 0xd1_12,
    @"mul-int/lit16" = 0xd2_12,
    @"div-int/lit16" = 0xd3_12,
    @"rem-int/lit16" = 0xd4_12,
    @"and-int/lit16" = 0xd5_12,
    @"or-int/lit16" = 0xd6_12,
    @"xor-int/lit16" = 0xd7_12,
    // Binary operations with 8-bit literal value
    @"add-int/lit8" = 0xd8_12,
    @"sub-int/lit8" = 0xd9_12,
    @"mul-int/lit8" = 0xda_12,
    @"div-int/lit8" = 0xdb_12,
    @"rem-int/lit8" = 0xdc_12,
    @"and-int/lit8" = 0xdd_12,
    @"or-int/lit8" = 0xde_12,
    @"xor-int/lit8" = 0xdf_12,
    @"shl-int/lit8" = 0xe0_12,
    @"shr-int/lit8" = 0xe1_12,
    @"ushr-int/lit8" = 0xe2_12,
    @"invoke-polymorphic" = 0xfa_45,
    @"invoke-polymorphic/range" = 0xfb_40,
    @"invoke-custom" = 0xfc_35,
    @"invoke-custom/range" = 0xfd_30,
    @"const-method-handle" = 0xfe_21,
    @"const-method-type" = 0xff_21,
    _,
};
